...
names of event types are recommended to follow the
...
The schema for event names is defined as follows:
...
functional name of the owning application. The uniqueness of this name
...
RESTful API, the event name should be the same as the resource name in the
RESTful API.
